<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Certificates.aspx.cs" Inherits="StaticSite.Certificates" %>
        ...
        <div xepan-component="xepan/cms/Tool_Container" emptytext="Container" style="width: 100%; margin: 0px auto; padding: 0%;" xepan-component-name="Container" class="xepan-component xepan-sortable-component xepan-cms-container ui-sortable margin_30" text-color="" data-extra-classes="margin_30" scrollamount="" id="xepan-ea8032d8-83c2-42d5-aea6-7b14097190c1">
                ...
                <div id="xepan-5326ad94-ea86-4b63-ed57-3abdfc14bdc0" xepan-component="xepan/cms/Tool_Container" emptytext="Container" style="width: 85%; margin: 40px auto 0px;" xepan-component-name="Container" class="xepan-component xepan-sortable-component xepan-cms-container ui-sortable" text-color="" scrollamount="">
                    <div id="xepan-726c4fe0-22d8-4a97-8c73-ea33b0713db0" xepan-component-name="Text" xepan-component="xepan/cms/Tool_Text" emptytext="Edit this text" class="xepan-component xepan-editable-text mce-content-body" style="position: relative;" text-color="" contenteditable="false">
                        <h2 data-mce-style="text-align: left;" style="text-align: left;">
                            <strong><span style="color: rgb(255, 255, 255);" data-mce-style="color: #ffffff;">Certificates</span></strong><br>
                        </h2>
                    </div>
                </div>
            </div>
            <div xepan-component="xepan/cms/Tool_Container" emptytext="Container" style="width: 100%; margin: 0px auto; background-color: rgb(255, 255, 255);" xepan-component-name="Container" class="xepan-component xepan-sortable-component xepan-cms-container ui-sortable bg-lightblue margin_30" text-color="" data-extra-classes="bg-lightblue margin_30" id="xepan-1352bd95-1caa-43a9-940b-45a6e51916a1">
                <div xepan-component="xepan/cms/Tool_Container" emptytext="Container" style="width: 85%; margin: 0 auto;" xepan-component-name="Container" class="xepan-component xepan-sortable-component xepan-cms-container ui-sortable gallery-wrapper" text-color="" data-extra-classes="gallery-wrapper" id="xepan-2d73b3bf-7fd6-460a-9e15-d3ccf2b135ed">
                    ...
                    <div class="xepan-component xepan-serverside-component" xepan-component-name="Gallery" xepan-component="xepan/cms/Tool_Gallery" id="xepan-18aeb95a-c6e0-4a89-f893-b8fef8984f48" text-color="" gallery_type="portfolio" show_fancybox="true" show_link="false" show_title="true" show_description="true" img_gallery_category="Certificate" data-options="0" default_active_category="Certificate" scrollamount="">
                        <div id="front_certificates_xepan_cms_tool_gallery" class="" style="">
                            <div id="front_certificates_xepan_cms_tool_gallery_view" style="" class=" tool-gallery-portfolio">
                                <div class="row">
                                    <div class="col-cs-12">
                                        <ul id="filter-list">
                                            ...
                                            <li data-filter="Certificate" class="filter">Certificate</li>
                                ...
                                <div class="container" style="width: 100%;">
                                    <ul class="portfolio_items">
                                        ...
                                        <li class="portfolio Certificate">
                                            <div class="post_thumb">
                                                <img style="width: 100%;" src="websites/sss/www/images/certificate/images/Shiv_Security_Service_Shop_Act_Liscence_Renewed.jpg" class="xepan-commerce-gallery-image-to-zoom" />

                                                <div class="portfolio-overlay">
                                                    <div class="overlay-inner">
                                                        <h3>Shiv Security Service Shop Act Liscence Renewed</h3>

                                                        <p></p>

                                                        <a href='websites/sss/www/images/certificate/images/Shiv_Security_Service_Shop_Act_Liscence_Renewed.jpg' class="fancybox fancybox-img">
                                        ...
                                        <li class="portfolio Certificate">
                                            <div class="post_thumb">
                                                <img style="width: 100%;" src="websites/sss/www/images/certificate/images/Shiv_Security_Service_Registration_Certificate.jpg" class="xepan-commerce-gallery-image-to-zoom" />

                                                <div class="portfolio-overlay">
                                                    <div class="overlay-inner">
                                                        <h3>Shiv Security Service Registration Certificate</h3>

                                                        <p></p>

                                                        <a href='websites/sss/www/images/certificate/images/Shiv_Security_Service_Registration_Certificate.jpg' class="fancybox fancybox-img">
                                                            <i class="fa fa-camera"></i>
                                                        </a>
                                        ...
                                        <li class="portfolio Certificate">
                                            <div class="post_thumb">
                                                <img style="width: 100%;" src="websites/sss/www/images/certificate/images/Shiv_Security_Service_Pan_Card.jpg" class="xepan-commerce-gallery-image-to-zoom" />

                                                <div class="portfolio-overlay">
                                                    <div class="overlay-inner">
                                                        <h3>Shiv Security Service Pan Card</h3>

                                                        <p></p>

                                                        <a href='websites/sss/www/images/certificate/images/Shiv_Security_Service_Pan_Card.jpg' class="fancybox fancybox-img">
                                                            <i class="fa fa-camera"></i>
                                                        </a>
                                        ...
                                        <li class="portfolio Certificate">
                                            <div class="post_thumb">
                                                <img style="width: 100%;" src="websites/sss/www/images/certificate/images/SHIV_SECURITY_SERVICE_OHSAS_18001.jpg" class="xepan-commerce-gallery-image-to-zoom" />

                                                <div class="portfolio-overlay">
                                                    <div class="overlay-inner">
                                                        <h3>SHIV SECURITY SERVICE OHSAS 18001</h3>

                                                        <p></p>

                                                        <a href='websites/sss/www/images/certificate/images/SHIV_SECURITY_SERVICE_OHSAS_18001.jpg' class="fancybox fancybox-img">
                                                            <i class="fa fa-camera"></i>
                                                        </a>
                                        ...
                                        <li class="portfolio Certificate">
                                            <div class="post_thumb">
                                                <img style="width: 100%;" src="websites/sss/www/images/certificate/images/SHIV_SECURITY_SERVICE_ISO_14001.jpg" class="xepan-commerce-gallery-image-to-zoom" />

                                                <div class="portfolio-overlay">
                                                    <div class="overlay-inner">
                                                        <h3>SHIV SECURITY SERVICE ISO 14001</h3>

                                                        <p></p>

                                                        <a href='websites/sss/www/images/certificate/images/SHIV_SECURITY_SERVICE_ISO_14001.jpg' class="fancybox fancybox-img">
                                                            <i class="fa fa-camera"></i>
                                                        </a>
                                        ...
                                        <li class="portfolio Certificate">
                                            <div class="post_thumb">
                                                <img style="width: 100%;" src="websites/sss/www/images/certificate/images/SHIV_SECURITY_SERVICE_ISO_9001_page-0001.jpg" class="xepan-commerce-gallery-image-to-zoom" />

                                                <div class="portfolio-overlay">
                                                    <div class="overlay-inner">
                                                        <h3>SHIV SECURITY SERVICE ISO 9001</h3>

                                                        <p></p>

                                                        <a href='websites/sss/www/images/certificate/images/SHIV_SECURITY_SERVICE_ISO_9001_page-0001.jpg' class="fancybox fancybox-img">
                                                            <i class="fa fa-camera"></i>
                                                        </a>
                                ...
                                <script>
                                    $('.portfolio_items').mixitup({
                                        showOnLoad: 'Certificate',
                                        targetSelector: '.portfolio',
                                        transitionSpeed: 450
                                    });
                                    $('#front_certificates_xepan_cms_tool_gallery_view a.fancybox-img').fancybox();
                                    $('#front_certificates_xepan_cms_tool_gallery_view a.fancybox-video').fancybox({
                                        type: 'iframe'
                                    });

                                        </script>
                                <style type="text/css">
                                    #front_certificates_xepan_cms_tool_gallery_view .portfolio.mix_all:last-child {
