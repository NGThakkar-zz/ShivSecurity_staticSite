                ...
                <div id="xepan-5326ad94-ea86-4b63-ed57-3abdfc14bdc0" xepan-component="xepan/cms/Tool_Container" emptytext="Container" style="width: 85%; margin: 40px auto 0px;" xepan-component-name="Container" class="xepan-component xepan-sortable-component xepan-cms-container ui-sortable" text-color="" scrollamount="">
                    <div id="xepan-726c4fe0-22d8-4a97-8c73-ea33b0713db0" xepan-component-name="Text" xepan-component="xepan/cms/Tool_Text" emptytext="Edit this text" class="xepan-component xepan-editable-text mce-content-body" style="position: relative;" text-color="" contenteditable="false">
                        <h2 data-mce-style="text-align: left;" style="text-align: left;">
                            <strong><span style="color: rgb(255, 255, 255);" data-mce-style="color: #ffffff;">Contact US</span></strong><br>
                        </h2>
                    </div>
                </div>
            </div>
            <div id="xepan-fd547e69-e239-47e8-d3c2-26b938265eab" xepan-component="xepan/cms/Tool_Container" emptytext="Container" xepan-component-name="Container" class="xepan-component xepan-sortable-component xepan-cms-container ui-sortable margin_60" text-color="" scrollamount="" style="width: 87%; margin-right: auto; margin-left: auto;" data-extra-classes="margin_60">


                <div id="xepan-a9d37b3c-8488-4520-805c-98726edb7b9f" xepan-component="xepan/cms/Tool_Container" emptytext="Container" style="width: 100%; margin: 0px auto; height: 400px; overflow: hidden;" xepan-component-name="Container" class="xepan-component xepan-sortable-component xepan-cms-container ui-sortable" text-color="">
                    <div id="xepan-1eb5c2e5-c6de-425c-cdc0-7058b6424607" style="" xepan-component="xepan/cms/Tool_HtmlBlock" xepan-component-name="Html Block" class="xepan-component htmlblock" text-color="" scrollamount="">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3627.7168036824487!2d73.71807901435221!3d24.598967884177956!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3967e5a7a041d91b%3A0xbfdd747c2625a641!2sUdaipurRealtors.com!5e0!3m2!1sen!2sin!4v1550913132638" style="border: 0" allowfullscreen="" height="400px" frameborder="0"></iframe>
                    </div>
                </div>
                <div xepan-component="xepan/cms/Tool_Columns" style="min-height: 20px;" xepan-component-name="Row/Columns" class="row xepan-component" id="xepan-e98d7e6c-1476-4fe5-80ec-32704d17e36c">
                    <div xepan-component="xepan/cms/Tool_Column" emptytext="Column 4" data-toolcolumnclass="xepan-tool-column" data-lg="5" data-md="5" data-sm="12" data-xs="12" xepan-component-name="Column" class="xepan-cms-column col-sm-12 col-xs-12 xepan-sortable-component xepan-component ui-sortable col-lg-5 col-md-5" id="xepan-821b570d-c074-4b6d-fc1c-87d01fed640f" text-color="">
                        <div id="xepan-5ada3e78-6450-4c10-eaea-f036ac281278" xepan-component="xepan/cms/Tool_Container" emptytext="Container" style="width: 100%; margin: 0px auto;" xepan-component-name="Container" class="xepan-component xepan-sortable-component xepan-cms-container ui-sortable box_style_1" text-color="" data-extra-classes="box_style_1">
                            <div xepan-component="xepan/cms/Tool_Columns" style="min-height: 20px;" xepan-component-name="Row/Columns" class="row xepan-component" id="xepan-d7e1af68-d7cf-4dc6-e411-0e0a7918faab" text-color="">
                            ...
                            <div xepan-component="xepan/cms/Tool_Columns" style="min-height: 20px;" xepan-component-name="Row/Columns" class="row xepan-component" text-color="" id="xepan-59029d9d-2deb-45a5-9249-4d0568ac1242">
                            ...
                            <div xepan-component="xepan/cms/Tool_Columns" style="min-height: 20px;" xepan-component-name="Row/Columns" class="row xepan-component" text-color="" id="xepan-259096d9-274a-4f2c-d1b7-0ff3e661437c">
                            ...
                            <div xepan-component="xepan/cms/Tool_Columns" style="min-height: 20px;" xepan-component-name="Row/Columns" class="row xepan-component" text-color="" id="xepan-b9717508-0a02-4c7c-ff1d-381b1f07549b">
                    ...
                    <div xepan-component="xepan/cms/Tool_Column" emptytext="Column 4" data-toolcolumnclass="xepan-tool-column" data-lg="7" data-md="7" data-sm="12" data-xs="12" xepan-component-name="Column" class="xepan-cms-column col-sm-12 col-xs-12 xepan-sortable-component xepan-component ui-sortable col-md-7 col-lg-7" id="xepan-29dea18c-ef49-4897-ae39-5f73c12e84ce" text-color="">
                        <div id="xepan-4d899918-e2f5-43f1-ea00-b225e95b1e7d" xepan-component-name="Text" xepan-component="xepan/cms/Tool_Text" emptytext="Edit this text" class="xepan-component xepan-editable-text mce-content-body" style="position: relative;" text-color="" contenteditable="false">
                            <h3>Contact Form<br>
                            </h3>
                        </div>
                                        ...
                                        <div class="">
                                            ...
                                            <div class="atk-form-row atk-form-row-line ">
                                                <div class="atk-push-xsmall atk-form-label atk-text-nowrap">
                                                    <label for="front_contact_xepan_cms_tool_customform_form_name">
                                                        <span>name:</span>
                                                    </label>
                                                </div>
                                            ...
                                            <div class="atk-form-row atk-form-row-line ">
                                                <div class="atk-push-xsmall atk-form-label atk-text-nowrap">
                                                    <label for="front_contact_xepan_cms_tool_customform_form_email">
                                                        <span>Email:</span>
                                                    </label>
                                                </div>
                                                <div class="atk-form-field atk-push-small ">
                                            ...
                                            <div class="atk-form-row atk-form-row-number ">
                                                <div class="atk-push-xsmall atk-form-label atk-text-nowrap">
                                                    <label for="front_contact_xepan_cms_tool_customform_form_mobile_no">
                                                        <span>mobile_no:</span>
                                                    </label>
                                                </div>
                                                <div class="atk-form-field atk-push-small ">
                                            ...
                                            <div class="atk-form-row atk-form-row-text ">
                                                <div class="atk-push-xsmall atk-form-label atk-text-nowrap">
                                                    <label for="front_contact_xepan_cms_tool_customform_form_message">
                                                        <span>message:</span>
                                                    </label>
                                                </div>
                                                <div class="atk-form-field atk-push-small ">
